  ...
  return (
    <group dispose={null}>
      ...
      <mesh
        ...
        position={[0.101, 0, -0.089]}
        rotation={[Math.PI / 2, 0, -0.146]}
        material-color={color.color}
      >
        {/* <Decal rotation={[-1.8, -9.5, 0]} position={[0, 0, -50]} scale={24}>
          <meshBasicMaterial
            map={textureOnShirt}
            polygonOffset
      ...
      <mesh
        castShadow
        receiveShadow
        geometry={(nodes.Frente as any).geometry}
        material={materials["Material.001"]}
        position={[0.101, 0, -0.089]}
        rotation={[Math.PI / 2, 0, -0.146]}
        material-color={color.color}
      >
        <Decal rotation={[-4.89, 9.5, 9.4]} position={[0, 0, -45]} scale={24}>
          <meshBasicMaterial
            map={textureOnShirt}
            polygonOffset
            polygonOffsetFactor={-6}
